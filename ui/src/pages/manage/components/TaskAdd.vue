...
// import { MessageListener,Message,StreamItem,MessageStatusListener,MessageStatus,MessageText,Channel,WKSDK,ChannelTypePerson,ChannelTypeGroup,ConnectStatus,ConnectStatusListener,MessageContentType,SendackPacket,Setting } from "wukongimjssdk";
...
export default {
    ...
    async mounted() {
        // this.connectIM(); //初始化悟空im   //这里如果要发送信息，也要集成悟空im
