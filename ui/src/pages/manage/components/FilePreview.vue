<template>
  <div class="file-preview">
    ...
    <template v-else-if="contentDetail">
      <div
        v-show="headerShow && !['word', 'excel', 'ppt'].includes(file.type)"
        class="edit-header"
      >
      ...
      <div style="width: 100%; heigh: 100%" class="content-body">
        <template v-if="file.type == 'document'">
          <MDPreview
            v-if="contentDetail.type == 'md'"
            :initialValue="contentDetail.content"
          />
          <TEditor
            v-else
